"""Bilingual UI string catalog for Anki AI Addon."""
...
_STRINGS: dict[str, dict[str, str]] = {
    ...
    "menu.tools.dev_playground": {
        "it": "Anki AI: Playground sviluppatori",
    ...
    "settings.thinking_budget_optimize": {
        "it": "Budget di thinking (ottimizzazione):",
        "en": "Thinking budget (optimize):",
    },
    "settings.thinking_budget_chat": {
        "it": "Budget di thinking (chat):",
    ...
    "settings.presets.error.invalid_schema_version": {
        "it": "schema_version non valido",
        "en": "invalid schema_version",
    },
    "settings.presets.error.unsupported_schema_version": {
        "it": "schema_version non supportato",
        "en": "unsupported schema_version",
    },
    "settings.presets.error.expected_object_or_array": {
        "it": "atteso un oggetto o un array",
        "en": "expected object or array",
    },
    "settings.presets.error.no_presets_found": {
        "it": "nessun preset trovato",
        "en": "no presets found",
    },
    "settings.presets.error.invalid_json": {
        "it": "JSON non valido",
        "en": "invalid json",
    },
    "settings.presets.copy_name": {
        "it": "{name} (copia)",
        "en": "{name} copy",
    },
    ...
    "settings.presets.summary.on": {
        "it": "attivo",
        "en": "on",
    },
    "settings.presets.summary.off": {
        "it": "disattivo",
        "en": "off",
    },
    "settings.presets.summary.empty": {
        "it": "(vuoto)",
        "en": "(empty)",
    },
    "settings.presets.summary.overrides": {
        "it": "{count} override",
        "en": "{count} override(s)",
    },
    "settings.presets.summary.runtime_defaults": {
        "it": "runtime: valori di fabbrica",
        "en": "runtime: factory defaults",
    },
    "settings.presets.summary.system_instruction": {
        "it": "istruzione di sistema",
        "en": "system instruction",
    },
    "settings.presets.summary.system_instruction_shared": {
        "it": "istruzione di sistema condivisa",
        "en": "shared system instruction",
    },
    "settings.presets.summary.system_instruction_optimize": {
        "it": "istruzione di sistema (ottimizzazione)",
        "en": "optimize system instruction",
    },
    "settings.presets.summary.system_instruction_chat": {
        "it": "istruzione di sistema (chat)",
        "en": "chat system instruction",
    },
    "settings.presets.summary.brain_import_message": {
        "it": "messaggio import nota",
        "en": "brain import message",
    },
    "settings.presets.summary.prompt_optimize_user": {
        "it": "prompt utente ottimizzazione",
        "en": "optimize user prompt",
    },
    "settings.presets.summary.prompt_chat_addon": {
        "it": "addon sistema chat",
        "en": "chat system addon",
    },
    "settings.presets.summary.prompt_dynamic_rules_prefix": {
        "it": "prefisso regole dinamiche",
        "en": "dynamic rules prefix",
    },
    "settings.presets.summary.prompt_chat_context_order": {
        "it": "ordine wrapper",
        "en": "wrapper order",
    },
    "settings.presets.summary.prompt_chat_context_sections": {
        "it": "sezioni wrapper",
        "en": "wrapper sections",
    },
    "settings.presets.summary.prompt_card_templates_format": {
        "it": "guida formato",
        "en": "format guide",
    },
    "settings.presets.summary.mathjax_preview_preamble": {
        "it": "preambolo MathJax",
        "en": "MathJax preamble",
    },
    "settings.presets.summary.dynamic_instructions": {
        "it": "istruzioni dinamiche",
        "en": "dynamic instructions",
    },
    "settings.presets.summary.model_optimize": {
        "it": "modello ottimizzazione",
        "en": "optimize model",
    },
    "settings.presets.summary.model_chat": {
        "it": "modello chat",
        "en": "chat model",
    },
    "settings.presets.summary.thinking_budget_optimize": {
        "it": "budget di thinking (ottimizzazione)",
        "en": "optimize thinking budget",
    },
    "settings.presets.summary.thinking_budget_chat": {
        "it": "budget di thinking (chat)",
        "en": "chat thinking budget",
    },
    "settings.presets.summary.temperature_optimize": {
        "it": "temperatura ottimizzazione",
        "en": "optimize temperature",
    },
    "settings.presets.summary.temperature_chat": {
        "it": "temperatura chat",
        "en": "chat temperature",
    },
    "settings.help.presets.link": {
        "it": "Preset prompt…",
        "en": "Prompt presets…",
    },
    "settings.help.presets.title": {
        "it": "Preset prompt",
        "en": "Prompt presets",
    },
    "settings.help.presets": {
        "it": (
            "I <b>preset prompt</b> salvano pacchetti di istruzioni, wrapper e testo correlato "
            "(e, se scelto, modelli/temperature/thinking).<br><br>"
            "<b>Predefinito</b> ripristina i valori di fabbrica del pacchetto prompt senza "
            "resettare modelli e temperature salvo che il preset nominato includa un pacchetto runtime.<br><br>"
            "Usa <b>Salva come…</b> / <b>Aggiorna</b> / <b>Duplica</b> / <b>Rinomina</b> / <b>Elimina</b> "
            "nella scheda Impostazioni. Puoi anche <b>importare/esportare</b> JSON (schema v2).<br><br>"
            "Nella chat, il menu {icon:pencil} → <b>Preset prompt</b> applica un preset alle "
            "impostazioni salvate (poi avvia una nuova conversazione per aggiornare tutto)."
        ),
        "en": (
            "<b>Prompt presets</b> save packs of instructions, wrapper, and related prompt text "
            "(and, optionally, models/temperatures/thinking).<br><br>"
            "<b>Default</b> restores factory prompt-pack values without resetting models and "
            "temperatures unless a named preset includes a runtime pack.<br><br>"
            "Use <b>Save as…</b> / <b>Update</b> / <b>Duplicate</b> / <b>Rename</b> / <b>Delete</b> "
            "in Settings. You can also <b>import/export</b> JSON (schema v2).<br><br>"
            "In chat, the {icon:pencil} menu → <b>Prompt presets</b> applies a preset to saved "
            "settings (then start a new conversation so everything refreshes)."
        ),
    },
    "common.card_fallback": {
        "it": "Carta {n}",
        "en": "Card {n}",
    },
    ...
    "note_apply.display.note_header": {
        "it": "Nota {n}",
        "en": "Note {n}",
    },
    "note_apply.display.notetype": {
        "it": "tipo di nota: {name}",
        "en": "notetype: {name}",
    },
    "note_apply.display.deck": {
        "it": "mazzo: {name}",
        "en": "deck: {name}",
    },
    ...
    "settings.help.chat_toolbar_icons": {
        "it": (
            ...
            "<b>Edit menu</b> — {icon:pencil} menu: modifica nota, wrapper contesto, template, Apply to Anki "
            "o preset prompt (solo sessione dove indicato).<br>"
            "<b>Import tipo di nota</b> — {icon:import}: importa tipi di nota (template/CSS) in chat.<br>"
        ...
        "en": (
            ...
            "<b>Edit menu</b> — {icon:pencil} menu: edit note, context wrapper, templates, Apply to Anki, "
            "or prompt presets (session-only where noted).<br>"
            "<b>Import note type</b> — {icon:import}: import note types (templates/CSS) into chat.<br>"
    ...
    "dev.playground.reset": {
        "it": "Azzera stato mock",
        "en": "Reset mock state",
    },
    "dev.playground.open_settings": {
    ...
    "prompt.inspect.pre_send.live_cache_tip": {
        "it": (
            ...
            "solo quelle nella scheda Cache la fanno ricreare."
        ),
        "en": (
